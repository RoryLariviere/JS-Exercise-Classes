...
class Person {
    constructor(name, age, persObj) {
        this.name = name;
        this.age = age;
        this.stomach = [];
    }
    eat(someFood) {
        return this.stomach.length < 10 ? this.stomach.push(someFood) : 'Still hungry!';
    }
    poop() {
        return this.stomach.length = 10 ? this.stomach = [] : `Momma didn't raise no quitter, keep eating!`;
    }
    toString() {
...
class Instructor extends Lambdasian {
    constructor(objInstructor) {
        super(objInstructor);
        this.specialty = objInstructor.specialty;
        this.favLanguage = objInstructor.favLanguage;
        this.catchPhrase = objInstructor.catchPhrase;
    }
    demo(str) {
